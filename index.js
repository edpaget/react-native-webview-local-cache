...
var WebViewLocalCacheState = keyMirror({
    IDLE: null,
    LOADING: null,
    ERROR: null,
});
 ...
 */
var WebViewLocalCache = React.createClass({

    propTypes: {
        ...RCTWebViewLocalCache.propTypes,
    ...
    getInitialState: function() {
        return {
            viewState: WebViewLocalCacheState.IDLE,
            lastErrorEvent: null,
    ...
    componentWillMount: function() {
        ...
        if (this.props.startInLoadingState) {
            this.setState({viewState: WebViewLocalCacheState.LOADING});
        }
    },
    ...
    render: function() {
        ...
        if (this.state.viewState === WebViewLocalCacheState.LOADING) {
            otherView = this.props.renderLoading && this.props.renderLoading();
        } else if (this.state.viewState === WebViewLocalCacheState.ERROR) {
            var errorEvent = this.state.lastErrorEvent;
            otherView = this.props.renderError && this.props.renderError(
                errorEvent.domain,
                errorEvent.code,
                errorEvent.description);
        } else if (this.state.viewState !== WebViewLocalCacheState.IDLE) {
            console.error('RCTWebViewLocalCache invalid state encountered: ' + this.state.loading);
        }

        var webViewStyles = [styles.container, this.props.style];
        if (this.state.viewState === WebViewLocalCacheState.LOADING ||
            this.state.viewState === WebViewLocalCacheState.ERROR) {
    ...
    goForward: function() {
        UIManager.dispatchViewManagerCommand(
            ...
            UIManager.RCTWebViewLocalCache.Commands.goForward,
            null
        );
    },
    ...
    goBack: function() {
        UIManager.dispatchViewManagerCommand(
            this.getWebViewLocalCacheHandle(),
            UIManager.RCTWebViewLocalCache.Commands.goBack,
            null
        );
    },
    ...
    reload: function() {
        UIManager.dispatchViewManagerCommand(
            this.getWebViewLocalCacheHandle(),
            UIManager.RCTWebViewLocalCache.Commands.reload,
            null
        );
    },
    ...
    getWebViewLocalCacheHandle: function() {
    ...
    onLoadingError: function(event) {
        ...
        this.setState({
            ...
            viewState: WebViewLocalCacheState.ERROR
        });
    },
